...
func main() {
	var myIntVar int
	myIntVar = -12
	fmt.Println("no mache loco la variable es: ", myIntVar)

	var myUintVar uint
	myUintVar = 12
	fmt.Println("no mache loco la otra variable es: ", myUintVar)

	var myStringVar string
	myStringVar = "y eso que loco"
	fmt.Println("no mache loco la variable string es: ", myStringVar)

	var myBooleanVar bool
	myBooleanVar = true
	fmt.Println("no mache loco la variable boleana es: ", myBooleanVar)

	fmt.Println("Mi direccion de variable es: ", &myStringVar)

	myIntVar2 := 12
	fmt.Println("Mi variable corta es: ", myIntVar2)

	// a partir de aqui son constantes, vamos a ver como determinar constantes

	const myFirstConst = "jamon"
	fmt.Println("Mi constante es: ", myFirstConst)
