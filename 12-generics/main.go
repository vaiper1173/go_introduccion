...
func anyType[N any](v1, v2 N) {
	fmt.Println("Any type values:")
	fmt.Println(v1, v2)
}

func anyTypeTwo[N1 any, N2 any](v1 N1, v2 N2) {
	fmt.Println("Any type two values:")
	fmt.Println(v1, v2)
}
...
func orderedValuescmp[N cmp.Ordered](v1, v2 N) {
	fmt.Println("Ordered values with cmp:")
	fmt.Println(v1, v2)
	fmt.Println(v1 != v2)
	fmt.Println(v1 < v2)
	fmt.Println(v1 > v2)
...
func MinN1[T N1](x, y T) T {
	fmt.Println("Minimum of two N1 numbers:")
	if x < y {
		return x
	}
	return y
